import type { Rule, RuleInsert, RuleUpdate, RuleCriteria, RuleCriteriaInsert, RuleCriteriaUpdate, RuleWithCriteria } from '../models/Rule';
...
export interface IRuleService {
   ...
   */
  createRuleWithCriteria(rule: RuleInsert, criteria: RuleCriteriaInsert[]): Promise<RuleWithCriteria>;
