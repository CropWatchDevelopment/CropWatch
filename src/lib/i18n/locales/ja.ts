export const strings = {
	...
	// All Reports page
	all_reports_heading: 'レポート一覧',
	all_reports_subheading: '設定済みのレポートを管理・表示します',
	search_reports_placeholder: 'レポートを検索…',
	download_selected: '選択したレポートをダウンロード',
	downloading: 'ダウンロード中...',
	bulk_download_description: '選択した各レポートのダウンロードに使用する期間を選択してください。',
	selection: '選択',
	select_all_reports_aria: 'すべてのレポートを選択',
	select_report_aria: 'レポート「{name}」を選択',
	bulk_progress_message: '{total} 件中 {current} 件をダウンロード中...',
	bulk_missing_date_range: '有効な期間を選択してください。',
	bulk_invalid_date_selection: '日付の選択が正しくありません。',
	bulk_start_after_end: '開始日は終了日より前である必要があります。',
	bulk_no_reports_available: 'ダウンロード可能なレポートがありません。',
	bulk_report_missing_identifier: 'レポート「{name}」にデバイスIDがありません。',
	bulk_unable_to_download: '「{name}」をダウンロードできませんでした。',
	bulk_partial_suffix: '（一部失敗）',
	bulk_download_success: '{reportWord}{count}件をダウンロードしました{partial}。',
	download: 'ダウンロード',
	no_reports_match_search: '検索条件に一致するレポートがありません。',
	no_reports_found: 'レポートが見つかりません。',
	untitled_report: '名称未設定のレポート',
	None: 'なし',
	...
	'Contains a lowercase letter (a-z)': '英小文字 (a-z) を含む',
	'Contains an uppercase letter (A-Z)': '英大文字 (A-Z) を含む',
	'Contains a number (0-9)': '数字 (0-9) を含む',
	'Contains a symbol (!@#$, etc.)': '記号 (!@#$ など) を含む',
	...
	'Required Agreements': '必須の同意事項',
	'All three agreements must be accepted to register': '登録するには3つすべての同意が必要です',
	...
	'Password must be at least 8 characters and include a lowercase letter, uppercase letter, number, and symbol':
		'パスワードは8文字以上で、英小文字・英大文字・数字・記号を含める必要があります',
