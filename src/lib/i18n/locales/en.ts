export const strings = {
	...
	// All Reports page
	all_reports_heading: 'All Reports',
	all_reports_subheading: 'Manage and view all your configured reports',
	search_reports_placeholder: 'Search reports...',
	download_selected: 'Download Selected',
	downloading: 'Downloading...',
	bulk_download_description: 'Choose the date range used for each selected report download.',
	selection: 'Selection',
	select_all_reports_aria: 'Select all reports',
	select_report_aria: 'Select report {name}',
	bulk_progress_message: 'Downloading {current} of {total}...',
	bulk_missing_date_range: 'Please choose a valid date range.',
	bulk_invalid_date_selection: 'Date selection is invalid.',
	bulk_start_after_end: 'Start date must be before end date.',
	bulk_no_reports_available: 'No reports available to download.',
	bulk_report_missing_identifier: 'Report {name} is missing a device identifier.',
	bulk_unable_to_download: 'Unable to download {name}.',
	bulk_partial_suffix: ' (some failed)',
	bulk_download_success: '{count} {reportWord} downloaded{partial}.',
	download: 'Download',
	...
	'Contains a symbol (!@#$, etc.)': 'Contains a symbol (!@#$, etc.)',
	Company: 'Company',
	'Acme Inc.': 'Acme Inc.',
	...
	'Required Agreements': 'Required Agreements',
	'All three agreements must be accepted to register':
		'All three agreements must be accepted to register',
	...
	'Relay 1': 'Relay 1',
	'Relay 2': 'Relay 2',
	'Next action available in {seconds}s': 'Next action available in {seconds}s',
	'Checking relay status…': 'Checking relay status…',
	...
	'Relay {number} {state}': 'Relay {number} {state}',
	'Downlink failed: {reason}': 'Downlink failed: {reason}',
	'Downlink failed': 'Downlink failed',
