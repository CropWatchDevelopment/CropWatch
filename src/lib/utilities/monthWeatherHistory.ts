...
export async function fetchHistoricalWeather(startDate: Date = new Date(), endDate: Date = moment().subtract(1, 'day').toDate(), latitude: number = 32.1085, longitude: number = 131.4013): Promise<any[]> {
