...
import type { ReportTemplate, ReportTemplateInsert, ReportTemplateUpdate } from '../models/ReportTemplate';
import { ErrorHandlingService } from '../errors/ErrorHandlingService';

@injectable()
export class ReportTemplateService {
  constructor(
    @inject(TYPES.ReportTemplateRepository) private repo: ReportTemplateRepository,
