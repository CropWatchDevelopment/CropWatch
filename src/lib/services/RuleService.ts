...
export class RuleService implements IRuleService {
   ...
   */
  constructor(
    @inject(RuleRepository) private ruleRepository: RuleRepository
  ) {}
   ...
   */
  async createRuleWithCriteria(rule: RuleInsert, criteria: RuleCriteriaInsert[]): Promise<RuleWithCriteria> {
