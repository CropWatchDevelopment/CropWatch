...
<svelte:head>
	<title>{m.reports_new_create_page_title()}</title>
</svelte:head>

<AppPage width="lg">
	<CwButton id="report-create-back-button" variant="secondary" size="sm" onclick={() => goto(resolve('/reports'))}>
		&larr; {m.action_back()}
	</CwButton>

	<div class="reports-new-create__header">
