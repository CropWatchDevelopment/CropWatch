...
<section>
	...
	<ol>
		...
		<li>「本サービス利用契約」とは、顧客と当社との間の本サービスの利用に関する契約をいう。</li>
		<li>
...
<section>
	<h2>第3章 顧客情報の取得・利用等</h2>

	<h3>第 3.1 条(顧客情報の取得・利用等)</h3>
	<ol>
		<li>
			...
			<ol>
				<li>顧客が本サービス利用契約締結時に登録した住所、氏名、メールアドレス等の情報</li>
		...
		<li>
			...
			<ol>
				...
				<li>顧客以外の者に対するアフターサービスその他のサポート体制を向上させる目的</li>
				<li>当社の製品・サービスの開発・改善等のために利用する目的</li>
				<li>統計数値その他匿名データの作成及びその分析のために利用する目的</li>
				<li>当社と顧客との間のコミュニケーション(アンケート、問い合わせ対応等を含む)</li>
		...
		<li>
			...
			<ol>
				<li>法令に基づいて、開示が必要であると当社が合理的に判断した場合</li>
				<li>
...
<section>
	<h2>第4章 本データの取得・管理等</h2>

	<h3>第 4.1 条(本データの取得・管理等)</h3>
	<ol>
		<li>
		...
		<li>顧客は、当社が匿名データを第三者に提供する場合があることをあらかじめ同意する。</li>
		<li>
...
<section>
	...
	<ol>
		<li>当社若しくは第三者の知的財産権その他の権利を侵害する行為又は侵害するおそれのある行 為</li>
		<li>本サービスの内容や本サービスにおいて利用しうる情報を改ざん又は消去する行為</li>
		<li>
...
<section>
	...
	<h3>第 7.4 条(契約終了後の処理)</h3>
	<ol>
		<li>顧客は、本サービス利用契約の終了後は、本サービスを利用することができないものとする。</li>
		<li>
	...
	<h3>第 7.5 条(存続条項)</h3>
	<p>第 3.1 条乃至第 7.10 条は、本サービス利用契約の終了後も引き続き効力を有する。</p>

	<h3>第 7.6 条(地位等の譲渡禁止)</h3>
	<p>
	...
	<h3>第 7.9(準拠法)</h3>
	<p>本規約及び本サービス利用契約の成立、効力、履行及び解釈に関する準拠法は、日本法とする。</p>
...
<footer>
	<p>
		<time datetime="2024-08-01">2024 年 8 月 1 日</time> 制定・施行
	</p>
</footer>
